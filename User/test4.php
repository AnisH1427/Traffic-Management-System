      ...
      <div class="w3-bar-block">
        ...
        <div class="w3-card w3-round w3-white">
          <div class="w3-container w3-padding">
            ...
            <p><input class="w3-input w3-border" type="text" placeholder="Aa"  name="post" required></p><br>
            <!-- <p contenteditable="true" class="w3-border w3-padding"></p><br> -->
            <button type="button" class="w3-button w3-black"><i class="fa fa-paper-plane w3-margin-right"></i>Post</button>
          </div>
        </div>
      </div>
